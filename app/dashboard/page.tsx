...
export default function DashboardPage() {
  ...
  const newToday = items.filter(i => i.first_scan === true).length
      ...
      <div className="page">
        ...
        <div className="stagger" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10, marginBottom: 18 }}>
          {[
            ...
            { label: 'New This Scan',   value: newToday,        color: 'var(--success)', icon: <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg> },
          ].map((s, i) => (
        ...
        {loading ? (
          ...
          <div className="stagger" style={{
            ...
            {visibleItems.map(item => (
              <div key={item.id} style={{ position: 'relative' }} className={item.first_scan ? 'item-new' : ''}>
